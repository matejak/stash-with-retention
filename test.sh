...
test "${xone12[0]}" = "$testdir/xone-1"
test "${xone12[1]}" = "$testdir/xone-2"

test "${xone04[0]}" = "$testdir/xone-0"
test "${xone04[1]}" = "$testdir/xone-4"
